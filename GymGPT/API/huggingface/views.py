...
def getMachineInfo(request):
    try:
        ...
        return Response({'Machine_name': machine_info.nom_maquina.capitalize(),'Machine_info':machine_info.MachineInfo, 'message': 'Machine Info GET LAST BY USER'}, status=status.HTTP_200_OK)
